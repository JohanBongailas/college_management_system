                                ...
                                @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" data-url="{{ route('students.destroy', $student->id) }}"
                                                data-name="{{ $student->name }}"
                                                class="btn btn-danger btn-sm delete-student-btn delete" title="Delete"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 shadow-lg">
                    <div class="modal-header bg-danger text-white border-0">
                        <h6 class="modal-title fs-5" id="deleteConfirmationLabel">Delete Confirmation</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body fs-5 text-center">
                        <p class="mb-4">Are you sure you want to delete <span id="studentName"
        ...
        <script src="{{ asset('js/student_delete_script.js') }}"></script>
